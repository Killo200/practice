...
public class PersonController {
    ...
    @PostMapping("/list")
    public List<PersonFilterIn> getPersonByFilter(@Valid @RequestBody PersonFilterIn personFilterIn) {
        return personService.getPersonByFilter(personFilterIn);
    }
    ...
    public void updatePerson(@Valid @RequestBody PersonViewUpdate personViewUpdate) {
        personService.updateOrganization(personViewUpdate);
    }
